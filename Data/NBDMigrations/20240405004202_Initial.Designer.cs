...
namespace NBD3.Data.NBDMigrations
{
    ...
    [Migration("20240405004202_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NBD3.Models.ProjectPhoto", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("NBD3.Models.ProjectThumbnail", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("NBD3.Models.StaffPhoto", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("NBD3.Models.StaffThumbnail", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("NBD3.Models.ProjectPhoto", b =>
                {
                    b.HasOne("NBD3.Models.Project", "Project")
                        .WithOne("ProjectPhoto")
                        .HasForeignKey("NBD3.Models.ProjectPhoto", "ProjectID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("NBD3.Models.ProjectThumbnail", b =>
                {
                    b.HasOne("NBD3.Models.Project", "Project")
                        .WithOne("ProjectThumbnail")
                        .HasForeignKey("NBD3.Models.ProjectThumbnail", "ProjectID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
